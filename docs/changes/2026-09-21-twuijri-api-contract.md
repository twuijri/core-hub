...
## المشكلة والهدف
لا يوجد عقد لواجهة Majlis بعد؛ العملاء الحاليون (أندرويد/iOS) يكتبون المسارات يدويًا
...
- الغرفة النظيفة (ADR 0004): لم يُفتح أي مصدر لـ Hermes Studio / Ekko Studio ولا
  `packages/*` في نسخة المالك. المصادر المقروءة: وثائق `majlis/docs/`، عميلا الهاتف
