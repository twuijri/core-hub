...
## القرار والموافقات
قرار العقد §63 (رقم 54 أخذه طلب #121) في `docs/contracts/DECISIONS.md` — **مقترح، بانتظار تأكيد المالك**:
...
- **لماذا لا يُحترم `input_mode` / `output_mode` في الويب:** المتعرّف في Chrome خدمة سحابية
  ...
  احتياطًا فقط، ويترك الحقلين للهواتف (§63). مقترح.
...
- `docs/contracts/DECISIONS.md` §63.
...
CI على طلب الدمج #123 (التشغيل 36092725337، قبل إعادة ترقيم القرار إلى §63 فقط):
...
- طلب الدمج بالإنجليزية إلى `main`، والمالك يؤكد §63 (خصوصًا: الويب يترك
