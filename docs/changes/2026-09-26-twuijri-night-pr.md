...
- تسجيل الدفع يُمسح حين ينهي المركز الجلسة التي سجّلته (وFCM يقول إن الرمز غير صالح)، وسجلات الجوال وأداؤه من المسارين الحيين، وإزالة نوعي `logs`/`performance` من `audit.getReport` (§74) — `feat/push-cleanup-mobile-logs` — `docs/changes/2026-09-26-twuijri-push-cleanup-mobile-logs.md`
