...
نسخة الإصدار (R8 وتقليص الموارد، غير موقّعة) بُنيت محليًا مرة للقياس، من فرع الجزء ٣ (الأجزاء
الثلاثة معًا): `app-release-unsigned.apk` ‏2,564,370 بايت (٢٫٦ م.ب). لم تُشغَّل على جهاز.
