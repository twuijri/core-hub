...
1. **تسمية المحادثة تعرض على النموذج كل الأدوات.** بعد أول رد يسأل الهب وكيل الجلسة «Name this
   conversation» (قرار العقد §92، وكان §26). الطلب كان يصل هرمز دورًا كاملًا ومعه أدوات البروفايل كلها (١٩ أداة في تشغيل
...
لا شيء في `packages/contracts`. فقرة جديدة تحت قرار التسمية في `docs/contracts/DECISIONS.md` (§92، وكان §26، «The hub names a
...
- التوثيق: `docs/contracts/DECISIONS.md` (§92، وكان §26)، `docs/STATUS.md` (سطر sessions)، فهرس الليلة.
