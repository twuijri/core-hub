...
## القرار والموافقات
**مقترح — بانتظار تأكيد المالك** (DECISIONS §46):
...
- `docs/contracts/DECISIONS.md` §46، و`docs/contracts/COVERAGE.md` (صف شريط الإجراءات المعلّقة
  وصف 36).
...
- ينتظر تأكيد المالك لـ DECISIONS §46 (واحدة لكل شخص في كل بروفايل، بلا صلاحيات عابرة).
