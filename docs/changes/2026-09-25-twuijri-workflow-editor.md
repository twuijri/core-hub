...
- **الاتجاه (مقترح — ينتظر تأكيد المالك)**: الرسم يجري باتجاه القراءة. `position.x` في العقد
  **منطقي** (المسافة على اتجاه القراءة)، واللوحة تنعكس بتحويل واحد في العربية، وكل عقدة تعكس
  ...
  بالإنجليزية من اليسار إلى اليمين، بلا تخطيط ثانٍ مخزَّن. سجّلته في DECISIONS §52.
...
## العقد
DECISIONS §52 (مقترح — ينتظر تأكيد المالك):
...
- الوثائق: `docs/contracts/DECISIONS.md` §52، `docs/STATUS.md`.
...
وشكل ملاحظاته، و`output`/`route` في الخطوة (DECISIONS §52).
