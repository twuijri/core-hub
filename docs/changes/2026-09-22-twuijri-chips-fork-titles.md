...
- قرار مرقَّم جديد `§26` (صار §91 في ٢٠٢٦-٠٩-٢٧: كان الرقم مكررًا) في `docs/contracts/DECISIONS.md` بشقّيه (التفريع، والتسمية).
...
- `docs/contracts/DECISIONS.md` — §26 (الآن §91).
