...
### قرارات للمالك
وافق المالك على الأول والثاني في الجلسة (٢٠٢٦-٠٩-٢٤): «صح» على كلٍّ منهما. الثالث تفصيل في العقد
لا يغيّر ما يراه الشخص.
...
3. `before` غريب عن المحادثة صار `404` بدل أحدث صفحة (قرار العقد §31).
...
- `sessions.listMessages`: وصف التقسيم المفتاحي، و`404` لمؤشّر ليس رسالة في هذه المحادثة (الرمز
  `404` كان معلنًا).
- `docs/contracts/DECISIONS.md` §31. لا عملية ولا حدث جديد؛ العملاء المولَّدون أعيد توليدهم
