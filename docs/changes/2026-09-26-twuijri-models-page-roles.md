...
- ~~التالي: تجربة الإضافة في دور هرمز حقيقي بالصورة~~ — **تمّت** (٢٠٢٦-٠٩-٢٦، `fix/voice-test-and-image-e2e`،
  السجل `2026-09-26-twuijri-voice-test-image-e2e.md`): الإضافة ترسم في دور هرمز حقيقي بالبروتوكولين، وظهر أن الصورة
  لا تعود إلى المحادثة (تبقى في ذاكرة هرمز المؤقتة) فأُصلح ذلك هناك.
- الباقي: التجربة على cli-proxy-api الحقيقي بـ`gemini-3.1-flash-image` (شكل الردّ جُرِّب على خادم مُبرمج بشكله فقط).
