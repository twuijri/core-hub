...
- قرار العقد **§70** في `docs/contracts/DECISIONS.md`. **الرقم أُخذ والدمج التكاملي لـ٣٦ طلب دمج
...
- `DECISIONS.md` §70 (قد يحتاج إعادة ترقيم).
...
- للمالك: تأكيد القرارات المقترحة أعلاه، ورقم §70 بعد الدمج التكاملي.
