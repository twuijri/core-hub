...
CI على طلب الليلة #165 (التشغيل 36206796685، رأس `74aa2c72` الذي يحوي هذا العمل): كل الوظائف نجحت — Lint/typecheck/
contracts/client tests/build، وشظايا اختبارات الخادم الثلاث، وWeb smoke journeys (Playwright)، وDesktop app smoke،
وdb:generate + db:migrate (SQLite وPostgreSQL)، وDocker؛ وفحوص الطلب كلها: 18 نجاح وواحد متخطّى. في تشغيل سابق
(36206364519) فشل Desktop app smoke مرة بمهلة إغلاق عامل Playwright في اختبار الإقران ونجح في إعادته، ثم نجح كاملًا في
التشغيل التالي — تذبذب لا صلة له بهذا التغيير.
