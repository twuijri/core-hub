...
**مقترحة — بانتظار تأكيد المالك** (DECISIONS §56):
...
- `docs/contracts/DECISIONS.md` §56، و`docs/contracts/COVERAGE.md` صفّا ١٠ و٣٣. STATUS: ‏209 من 267.
...
- للمالك: تأكيد §56 (خصوصًا: وكيل البروفايل الافتراضي لكل المحادثات، وإهمال حقلي المركز بدل حذفهما، وإعادة
