...
## القرار والموافقات
النطاق من طلب المالك لليلة. الاختيارات الجديدة **مقترحة — للمالك أن يؤكد** (DECISIONS §96 و§97، وتعديل §87):
...
- الوثائق: DECISIONS §96 و§97 وتعديل §87، STATUS، COVERAGE.
...
- للمالك: تأكيد §96 (المركز بابًا عامًا، المنافذ، `deliver` = `log` أو قناة مشغّلة) و§97 (حد 64 غ.ب، أنواع العرض في
  الصفحة) وتعديل §87.
