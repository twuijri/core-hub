...
الأيقونة داخل الـ.ipa ولا سطور actool، فلم أرَ الأيقونة في الـ.ipa الموقّع بعيني. الدليل غير مباشر:
الأرشيف مبني من `project.yml` نفسه الذي جعل actool على المحاكي يُخرج `AppIcon60x60@2x.png` و
`Assets.car` ونجح معه `AppIconTests`؛ الفحص النهائي هو قبول App Store Connect عند أول رفع.
