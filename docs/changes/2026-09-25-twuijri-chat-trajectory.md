...
قرار العقد: DECISIONS §42 (§41 محجوز لطلب إعادة التسمية المفتوح #99).
...
- DECISIONS §42، و`COVERAGE.md` (صف المحادثة).
...
`inspirations/ADOPTION-BACKLOG.md` (2.18)، `contracts/DECISIONS.md` §42، `contracts/COVERAGE.md`،
...
- **الأدوار مستنتَجة** من البث لا من نداءات النموذج الفعلية؛ وكيل يبث نصًّا أثناء عمل أدواته
  (وكلاء فرعيون) يظهر دوره متداخلًا مع أشرطة الأدوات. موثّق في §42.
