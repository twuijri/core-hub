...
بعد الإصلاح (الرأس `b6a8ab19`): **١٤ فحصًا كلها ناجحة** — الخادم بشرائحه الثلاث، العقد والعملاء والبناء، رحلات
الويب (Playwright على المركز الحقيقي)، الترحيل على SQLite وPostgreSQL، صورة Docker تجيب `/health`، سطح المكتب،
أندرويد، iOS، وعميل Swift، وسجل التغيير، وخريطة الشيفرة.
