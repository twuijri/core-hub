...
رُكِّب الفرع فوق `feat/chips-fork-titles`. التسمية التلقائية تُصدر حدث `session.updated`
إضافيًا بعد أول رد ناجح، فتغيّر تسلسل الأحداث المتوقَّع في اختبار الوضع المباشر؛ حُدِّث
التوقُّع بسطر معلَّق يقول سببه، لا بإسكات الاختبار. الفحوص على الشجرة المُركَّبة، مرّتين
متتاليتين بنفس النتيجة: الوحدات 11 + 105 + 64 + 428 (وتخطّيان مقصودان) + 296، والعقد 254،
وlint وbuild نظيفة، و12 رحلة متصفح.
