...
- المهام بالترتيب: البدء التلقائي ينتظر الاعتماديات، مراقب المهام المتوقفة، حمولة «نُقلت المهمة»، الأرشيف عند الطلب (§92)، §26 المكرر صار §91، إصلاح اختبار الرموز المتذبذب، قوالب GitHub ثنائية اللغة (B7 + B22) — `feat/tasks-in-order` — `docs/changes/2026-09-27-twuijri-tasks-in-order.md`
