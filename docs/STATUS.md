...
- **Web** (`packages/web`): first-run setup, login, chat with streaming,
  ...
  since 2026-09-25 **`/` commands in the composer** (decision §52): typing `/` opens a menu
