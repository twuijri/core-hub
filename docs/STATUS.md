...
**201 of 259 contract operations are implemented.** Nothing fakes a success:
...
- **Web** (`packages/web`): first-run setup, login, chat with streaming,
  ...
  conversation page by page, keeping the reader's place — sessions list, agents, models, the Tasks board,
  ...
  from a file, since 2026-09-24), knowledge, plugins, updates, about, settings, pairing. Screens whose module is still 501 say so explicitly
