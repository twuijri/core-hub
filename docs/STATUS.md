...
**348 of 348 contract operations are implemented.** Nothing fakes a success:
...
- **Web** (`packages/web`): first-run setup, login, chat with streaming,
  approvals and resume — since 2026-09-27 (DECISIONS §102, proposed — owner to confirm) an
...
- **The phones' missing sections, both apps** (since 2026-09-27,
  ...
  **Share to Core Hub** takes pictures, videos and files (a new chat with them attached); **Models**
  ...
  location** for an agent that asks (§103: a run may ask, the hub's `devices.locate` tool, a
