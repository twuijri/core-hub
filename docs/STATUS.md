...
- **Web** (`packages/web`): first-run setup, login, chat with streaming,
  ...
  realtime.
  Since 2026-09-25 **«الملفات» / Files** (Settings → tools, owner and admin; DECISIONS §56,
