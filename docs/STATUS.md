...
**198 of 259 contract operations are implemented.** Nothing fakes a success:
...
- **Web** (`packages/web`): first-run setup, login, chat with streaming,
  ...
  opens it there), notifications, people, workspaces (with export to a download and import
