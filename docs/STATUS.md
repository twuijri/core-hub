...
| models | 26 | 26 | providers, keys, catalogue, defaults, verification on save, speech (ADR 0010); providers, keys and models shared by every profile, model choices per profile inheriting the default profile's (decision §34) |
