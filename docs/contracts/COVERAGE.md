...
| 10 | `settings` › **Webhooks** (admin) | `notify.listWebhooks`, `notify.listWebhookEvents`, `notify.listWebhookDeliveries` | `notify.createWebhook`, `notify.updateWebhook`, `notify.deleteWebhook`, `notify.testWebhook` | `job.completed` (test) |
