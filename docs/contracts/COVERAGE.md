...
| `agents.receiveWebhook` | outside services (GitHub, a form, a script) POSTing to an agent's webhook route; the hub passes it to Hermes (DECISIONS §96) |
