// The speech tabs' pickers (DECISIONS §87): a Groq voice chosen from the provider's documented
...
describe('speech voice picker (§87)', () => {
...
describe('adding a speech provider (§87)', () => {
  const PRESETS = [
    {
      id: 'groq-tts',
