// The speech tabs' pickers (DECISIONS §94): a Groq voice chosen from the provider's documented
...
describe('speech voice picker (§94)', () => {
...
describe('adding a speech provider (§94)', () => {
  const PRESETS = [
    {
      id: 'groq-tts',
