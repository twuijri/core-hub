...
export function OpenSession(props: OpenSessionProps) {
  // One voice for the whole conversation: every speaker and voice mode share it (§54).
  return (
    <VoiceProvider>
...
function OpenSessionBody({ sessionId, title: pageTitle, intro }: OpenSessionProps) {
  ...
  // Voice (contract decision §54): the full-screen stage, and reading replies aloud as
