 ...
 *
 * A video or a sound plays in the panel (§92) from a one-hour stream address, a byte range at a
...
function FileView({ sessionId, file }: { sessionId: string; file: SessionFile }) {
  ...
  // A video or a sound is played from a stream address, never read whole into the page (§92).
