...
| `subagent.started` | sessions module from the agent's delegation reports | `subagent`: `Subagent` | A delegated subagent began (DECISIONS §49). Profile-wide, so the Background panel hears it anywhere. |
