...
export interface TrajectoryStep {
  ...
  /** The subagent of a `subagent` step (§56). */
...
export interface TrajectorySource {
  ...
  /** The conversation's subagents (§56); none when absent. */
...
/**
 * Subagents get a lane of their own (§56): every tool call a subagent made moves there, and each
