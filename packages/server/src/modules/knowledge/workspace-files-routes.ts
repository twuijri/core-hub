...
const INLINE_TYPES = new Set([
  ...
  'application/pdf',
  'text/plain',
  // Played in place, a range at a time (decision §98); a media type never runs as a page.
  'video/mp4',
  'video/webm',
  'video/ogg',
  'video/quicktime',
...
export function registerWorkspaceFileRoutes(
  ...
  // A media element cannot send the bearer: one file, one hour, a ticket in the path (§98).
  defineRoute(app, deps, {
