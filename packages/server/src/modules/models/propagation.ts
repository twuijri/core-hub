...
export interface PropagationState {
  ...
  hermesImage?: boolean;
  /**
   * The profile's speech-to-text and text-to-speech choices in Hermes's words (DECISIONS §91),
...
/**
 * One side of Hermes's voice (DECISIONS §91): `<side>.provider` and the keys of that provider's
